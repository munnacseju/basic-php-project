...
<head>
	...
	<script type="text/javascript">
		...
		function confirmFun () {
			...
			var value = confirm("Are you sure, you are an admin?")
			if(value==true){
...
<body>
	...
	<div class="row">
		<div class="col-md-12">
			<h1 class="text-center text-uppercase text-info">welcome to orphanage fund</h1>
...
<div class="container">
  <div>
    <div class="text-center w-50 p-1 m-auto">
      ...
      <a class="btn btn-info w-100" href="display.php">See the orphan donation cart</a>
    </div>
  </div>
</div>
	<div class="btn btn-danger m-auto " onclick="confirmFun()">Conform for Regirstrations</div>
